...
// const Comment = ({ comment, postId, fetchPosts, initiateReply }) => {
...
//               <img src={comment.attachmentUrl} alt="Attachment" className="img-fluid mb-2" />
//             ) : (
//               <video controls className="mb-2">
//                 <source src={comment.attachmentUrl} type={`video/${comment.attachmentType.split('/')[1]}`} />
//               </video>
//             )
//           )}
...
//             <FontAwesomeIcon icon={faReply} onClick={() => initiateReply(comment._id)} className="text-primary mr-2" />
...
//             <Comment key={reply._id} comment={reply} postId={postId} fetchPosts={fetchPosts} initiateReply={initiateReply} />
//           ))}
//         </div>
//       </div>
//     </div>
